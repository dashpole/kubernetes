...
func (c *FakePods) Get(_ context.Context, name string, options v1.GetOptions) (result *corev1.Pod, err error) {
	obj, err := c.Fake.
...
func (c *FakePods) List(_ context.Context, opts v1.ListOptions) (result *corev1.PodList, err error) {
	obj, err := c.Fake.
...
func (c *FakePods) Watch(_ context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakePods) Create(_ context.Context, pod *corev1.Pod) (result *corev1.Pod, err error) {
	obj, err := c.Fake.
...
func (c *FakePods) Update(_ context.Context, pod *corev1.Pod) (result *corev1.Pod, err error) {
	obj, err := c.Fake.
...
func (c *FakePods) UpdateStatus(_ context.Context, pod *corev1.Pod) (*corev1.Pod, error) {
	obj, err := c.Fake.
...
func (c *FakePods) Delete(_ context.Context, name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakePods) DeleteCollection(_ context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
...
func (c *FakePods) Patch(_ context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *corev1.Pod, err error) {
	obj, err := c.Fake.
...
func (c *FakePods) GetEphemeralContainers(_ context.Context, podName string, options v1.GetOptions) (result *corev1.EphemeralContainers, err error) {
	obj, err := c.Fake.
...
func (c *FakePods) UpdateEphemeralContainers(_ context.Context, podName string, ephemeralContainers *corev1.EphemeralContainers) (result *corev1.EphemeralContainers, err error) {
	obj, err := c.Fake.
