...
func (g *grpcCoreStatsProvider) Get(_ context.Context, _ *coreapi.StatsRequest) (*coreapi.StatsResponse, error) {
	return g.get()
}

func (g *grpcCoreStatsProvider) Stream(interval *coreapi.StatsInterval, stream coreapi.CoreStats_StreamServer) error {
	metricTicker := time.NewTicker(time.Duration(interval.GetDuration()))
...
func (g *grpcCoreStatsProvider) get() (*coreapi.StatsResponse, error) {
