...
func (pc podControlAdapter) CreatePodsWithControllerRef(ctx *trace.SpanContext, namespace string, template *v1.PodTemplateSpec, object runtime.Object, controllerRef *metav1.OwnerReference) error {
