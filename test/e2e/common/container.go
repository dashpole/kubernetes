...
func (cc *ConformanceContainer) Delete() error {
	return cc.PodClient.Delete(context.Background(), cc.podName, metav1.NewDeleteOptions(0))
}

func (cc *ConformanceContainer) IsReady() (bool, error) {
	pod, err := cc.PodClient.Get(context.Background(), cc.podName, metav1.GetOptions{})
	if err != nil {
		return false, err
	}
...
func (cc *ConformanceContainer) Present() (bool, error) {
	_, err := cc.PodClient.Get(context.Background(), cc.podName, metav1.GetOptions{})
	if err == nil {
		return true, nil
	}
